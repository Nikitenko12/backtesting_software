...
from sysinit.futures.bcutils.config import CONTRACT_MAP, EXCHANGES
        ...
        for contract in contract_list:
            ...
            for resolution in Resolution if do_daily else [Resolution.Hour, Resolution.Minute]:
                ...
                if _before_available_res(resolution, start_date, instr_config):
                    date_type = "tick" if resolution == Resolution.Hour or resolution == Resolution.Minute else "EOD"
                    logger.info(
...
def _before_available_res(resolution, start_date, instr_config):
    if "exchange" in instr_config:
        ...
        if resolution == Resolution.Hour or resolution == Resolution.Minute:
...
if __name__ == "__main__":
    ...
    get_barchart_downloads(
        create_bc_session(
            config_obj={
                "barchart_username": "xninvestments@gmail.com",
                "barchart_password": "$yM5!4n$y6FbMvA",
            }
        ),
        contract_map={
            "NQ": {"code": "NQ", "cycle": "HMUZ", "exchange": "CME"},
            "ES": {"code": "ES", "cycle": "HMUZ", "exchange": "CME"},
            "CL": {"code": "CL", "cycle": "HMUZ", "exchange": "NYMEX"},
            "GC": {"code": "NQ", "cycle": "HMUZ", "exchange": "COMEX"},
        },
